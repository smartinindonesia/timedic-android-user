...
public class MessageListAdapter extends RecyclerView.Adapter {
    private static final int VIEW_TYPE_MESSAGE_SENT = ChatMessage.MESSAGE_SENT;
    private static final int VIEW_TYPE_MESSAGE_RECEIVED = ChatMessage.MESSAGE_RECEIVED;
    ...
    public MessageListAdapter(Context context, Activity activity, List<ChatMessage> messageList) {
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getSender().equals(AdminListActivity.user.getId())) {
    ...
    public class SentMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(ChatMessage message) {
            ...
            timeText.setText(ConverterUtility.getTimeOnly(message.getMessageTime()));

            int defaultIcon = R.drawable.ic_single_thick;
            if (message.getStatus() == ChatMessage.STATUS_SENT){
                defaultIcon = R.drawable.ic_single_thick;
            } else if (message.getStatus() == ChatMessage.STATUS_RECEIVED_BY_USER){
                defaultIcon = R.drawable.ic_double_thick;
            } else if (message.getStatus() == ChatMessage.STATUS_READ_BY_USER) {
                defaultIcon = R.drawable.ic_single_thick_read;
            } else if (message.getStatus() == ChatMessage.STATUS_FAILED) {
