...
import id.pptik.org.homecaretimedic.model.submitmodel.PlaceInfo;
import id.pptik.org.homecaretimedic.model.submitmodel.SubmitInfo;
import id.pptik.org.homecaretimedic.service.LocationService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                zoomToMyLoc = true;
                progressDialog.setTitle("Waiting for location info");
        ...
        btnChooseTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                timePickerDialog = new TimePickerDialog(MapSelectorActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        wktPelayanan.setText(hourOfDay + ":" + minute);
                    }
                }, hours, minute, true);
                timePickerDialog.setTitle("Pilih tanggal pelayanan");
                timePickerDialog.show();
                wktPelayanan.setText(hours + ":" + minute);
            }
        });
        */
        ...
        btnGoToAssest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MapSelectorActivity.this, DateTimePickActivity.class);
        ...
        layanan = SubmitInfo.selectedLayanan;//g.fromJson(intenExtras.getStringExtra("jenis_layanan"), Layanan.class);
